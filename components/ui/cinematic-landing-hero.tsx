...
// Custom skeuomorphic animations and styles are defined globally in globals.css to avoid server-side dynamic style injection warnings.
...
export function CinematicHero({ 
  brandName = "Aura Luxe",
  tagline1 = "Elevate your style,",
  tagline2 = "redefine your space.",
  cardHeading = "Craftsmanship, redefined.",
  cardDescription = <><span className="text-white font-semibold">Aura Luxe</span> brings premium boutique items right to your fingertips. Elevate your daily aesthetic with our curated collections.</>,
  metricValue = 120,
  metricLabel = "Exclusive items",
  ctaHeading = "Explore the Collection.",
  ctaDescription = "Scroll down to browse our new premium products and find the perfect addition to your lifestyle.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  // Smooth scroll handler to e-commerce content
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* Custom styles are loaded globally from globals.css */}
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
          <a
            ...
            aria-label="Browse Boutique"
            className="btn-modern-light flex items-center justify-center gap-3 px-10 py-5 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
          >
            <span className="text-xl font-bold leading-none tracking-tight">Enter Boutique</span>
            <svg
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          <span className="text-[10px] text-neutral-400 uppercase tracking-widest font-bold mb-1">Live Store</span>
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Aura</span>
                        </div>
                        <div className="w-9 h-9 rounded-full bg-white/5 text-neutral-200 flex items-center justify-center font-bold text-sm border border-white/10 shadow-lg shadow-black/50">AL</div>
                      </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-blue-500/20 to-blue-900/10 flex items-center justify-center border border-blue-400/30 shadow-inner text-blue-400">
                    <Sparkles className="w-5 h-5 lg:w-6 lg:h-6 drop-shadow-lg" />
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Luxury Design</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Curated Essentials</p>
                  </div>
                </div>

                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full bg-gradient-to-b from-indigo-500/20 to-indigo-900/10 flex items-center justify-center border border-indigo-400/30 shadow-inner text-indigo-400">
                    <Package className="w-5 h-5 lg:w-6 lg:h-6 drop-shadow-lg" />
                  </div>
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">Free Shipping</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Worldwide delivery</p>
                  </div>
                </div>
